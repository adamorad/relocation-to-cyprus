...
export const SECTIONS_INDEX: ReadonlyArray<SectionEntry> = [
	...
	// Legal & Professional
	{
		...
		description:
			"Vetted conveyancing solicitors specialising in foreign buyer transactions.",
	},
	{
		...
		category: "Legal & Professional",
		description:
			"Immigration specialists covering digital nomad visas, PR by investment, and work permits.",
	},
	{
	...
	},
	{
		...
		category: "Business",
		description:
			"Day pass prices, WiFi speeds, and noise levels for 20+ coworking venues island-wide.",
	},
	...
	// Family & Education
	{
		...
		description:
			"Registered nurseries and pre-schools with English instruction across all districts.",
	},
	{
	...
	// Healthcare
	{
		...
		category: "Healthcare",
		description:
			"English-speaking specialist consultants with GeSY status and private pricing.",
	},
	{
		...
		category: "Healthcare",
		description:
			"English-speaking therapists, psychologists, and psychiatrists across Cyprus.",
	},
	{
